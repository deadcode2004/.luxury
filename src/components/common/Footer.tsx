  ...
  return (
    <footer className="bg-secondary text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-8">
          ...
          <div>
            ...
            <form className="flex flex-col space-y-3">
              <input
                ...
                className="bg-white/5 border border-white/10 rounded-md px-4 py-3 text-sm focus:outline-none focus:border-primary transition-colors w-full text-white placeholder-gray-500"
              />
              <button
                type="button"
                className="bg-primary hover:bg-primary/90 text-secondary font-bold tracking-wide rounded-md px-4 py-3 text-sm transition-colors w-full"
              >
        ...
        {/* الحقوق */}
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center text-gray-500 text-xs md:text-sm gap-4">
          ...
          <div className="flex items-center justify-center gap-3 text-gray-400">
            ...
            <FaCcMastercard size={24} className="hover:text-white transition-colors" />
            <FaCcPaypal size={24} className="hover:text-white transition-colors" />
          </div>
        </div>
      </div>
    </footer>
