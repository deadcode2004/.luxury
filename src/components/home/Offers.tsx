        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          ...
          <div className="relative group pt-4 lg:pt-8 w-full md:flex md:justify-end">
            ...
            >
              ...
              >
                <div className={`bg-gradient-to-br from-white/70 to-white/20 backdrop-blur-xl h-full w-full py-6 px-5 ${language === "ar" ? "pl-12" : "pr-12"} flex flex-col justify-center relative shadow-2xl border-x border-white/40`}>
          ...
          <div className="relative group pt-16 md:pt-4 lg:pt-8 w-full md:flex md:justify-start">
            ...
            >
              ...
              >
                <div className={`bg-gradient-to-br from-white/70 to-white/20 backdrop-blur-xl h-full w-full py-6 px-5 ${language === "ar" ? "pr-12" : "pl-12"} flex flex-col justify-center relative shadow-2xl border-x border-white/40`}>
