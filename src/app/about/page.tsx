    ...
    <>
      ...
      <main className="flex-grow pb-24 bg-background min-h-screen">
        ...
        <section className="relative h-[100vh] min-h-[600px] flex items-center justify-center overflow-hidden mb-24">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center container mx-auto px-4 md:px-8 text-center text-background mt-16">
            ...
            <p className="text-base md:text-lg text-gray-200 mb-10 max-w-3xl mx-auto drop-shadow-md leading-relaxed">
              {language === "ar" 
        ...
        <div className="container mx-auto px-4 md:px-8 mb-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="flex flex-col">
              ...
              <div className="space-y-6 text-secondary/80 text-lg leading-relaxed text-justify">
                <p>
                  {language === "ar"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="flex flex-col order-2 lg:order-1">
              ...
              <div className="space-y-6 text-secondary/80 text-lg leading-relaxed text-justify">
                ...
                <div className="mt-8 p-6 bg-surface/50 rounded-2xl border-r-4 border-primary rtl:border-r-4 rtl:border-l-0 ltr:border-l-4 ltr:border-r-0">
                  <p className="italic font-bold text-primary text-xl">
                    {language === "ar"
