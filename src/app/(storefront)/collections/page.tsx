          ...
          <div className="flex flex-col gap-16 md:gap-24 lg:gap-32">
            {categories.map((category, index) => (
              <div key={category.id} className={`flex flex-col ${index % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"} items-center gap-8 lg:gap-0`}>
                ...
                <div className={`w-11/12 mx-auto lg:w-5/12 bg-gradient-to-br from-white/60 to-white/10 backdrop-blur-xl glass-fix p-8 md:p-12 lg:p-16 rounded-[2rem] shadow-card z-20 -mt-16 lg:mt-0 ${index % 2 === 0 ? "lg:-ms-24" : "lg:-me-24"} border border-white transform transition-transform duration-500 hover:-translate-y-2`}>
